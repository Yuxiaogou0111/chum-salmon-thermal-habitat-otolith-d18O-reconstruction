...
This directory contains nine CSV files corresponding to individual otolith-based reconstructions.
...
[Yuxiao Gou et al.] (2026). Revealing thermal habitat use of chum salmon during primary ocean migration. Marine Ecology Progress Series.
